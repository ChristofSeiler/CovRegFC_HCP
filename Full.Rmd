...
Analysis based on data from all 820 subjects in the WU-Minn HCP 1200 Subjects Data Release with four complete rfMRI runs (with 100% of collected timepoints), yielding the following outputs at 6 ICA dimensionalities: Group-average parcellations via group-ICA, subject-specific parcellations, subject-specific node timeseries, and a set of subject-specific parcellated connectomes. 
